...
public class PoiAroundSearchActivity extends Activity implements OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.getStringExtra(dataName) != null) {
            if (intent.getStringExtra(dataName).equals("")) {
                ...
                keyWord = intent.getStringExtra(dataName);
    ...
    private void init() {
        ...
        float[] citySite = data.getFloatArray("siteXY");
        lp = new LatLonPoint(citySite[0], citySite[1]);
        ...
        if (mAMap == null) {
            ...
            ImageView searchButton = (ImageView) findViewById(R.id.btn_search);
    ...
    private void setup() {
        mPoiDetail = (CardView) findViewById(R.id.poi_detail);
    ...
    public void onPoiSearched(PoiResult result, int rcode) {
        if (rcode == AMapException.CODE_AMAP_SUCCESS) {
            if (result != null && result.getQuery() != null) {// 搜索poi的结果
                ...
                ToastUtil
                        .show(PoiAroundSearchActivity.this, "");
            }
        } else {
