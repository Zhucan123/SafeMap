...
import com.example.zhucan.safemap.util.TTSController;
...
public class BaseActivity extends Activity implements AMapNaviListener, AMapNaviViewListener {
    ...
    public void onInitNaviFailure() {
        Toast.makeText(this, "init navi_go Failed", Toast.LENGTH_SHORT).show();
    }
    ...
    public void onCalculateRouteFailure(int errorInfo) {
        ...
        Log.i("dm", "错误码详细链接见：http://lbs.amap.com/api/android-navi_go-sdk/guide/tools/errorcode/");
        Log.e("dm", "--------------------------------------------");
